...
if run_button:
    ...
    if not candles:
        ...
        with tab4:
            ...
            st.caption("Average moves, MAE and R:R per pattern")
        ...
        with tab5:
            ...
            if not fvg_summary:
                ...
                st.caption("How far did price drop from entry before recovering")
                ...
                st.caption("How far did price move up after FVG formed")
